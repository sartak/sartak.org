...
p { "I'm certain that at my skill level, one card is not enough to cement a completely new word in my passive vocabulary. Is two cards enough? Maybe. I'm sure five is sufficient. But if I can't get five sentences I don't hate, should I skip the word?" };
