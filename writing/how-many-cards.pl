...
p { "One of the questions I wonder about is how many flash cards I need to add to my flash card deck to learn a particular word or kanji well enough to have no trouble with it. There are certainly a lot of words such as 敢行 (decisive action) and 格納 (store away) that always seem to slip away from me. I suspect that is entirely because I have one flash card each for each of those words. I just don't have any other comprehensible sentences for those words in the corpus of text I'm accumulating. Should I give up and delete those two important sentences from my deck because I need to see more of those words to get them to stick into my head? Typically what I'll do instead, which has worked well for words like 薄皮 (thin covering film) and 七面鳥 (turkey), is to search Twitter which seems to always have thousands of short sentences for even the most obscure words." };
