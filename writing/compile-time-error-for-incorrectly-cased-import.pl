...
p { "Now when you `⌘B`, Xcode will tell you about all your miscased `#import` statements just like any other builtin error. It even shows these errors right in context." };
...
p { "For me, this is an error because all warnings are errors in my project. MTFU." };
