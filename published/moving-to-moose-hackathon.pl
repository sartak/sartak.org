...
figure {
img { src is "/img/blog/moving-to-moose-hackathon/yapc-audience.jpg" };
};
...
figure {
img { src is "/img/blog/moving-to-moose-hackathon/flight-in.jpg" };
};

figure {
img { src is "/img/blog/moving-to-moose-hackathon/oslo-bus.jpg" };
};

p { "結局、プレーケストーレンの山小屋に無事に到着しました。" };

figure {
img { src is "/img/blog/moving-to-moose-hackathon/lodge-lake.jpg" };
};

figure {
img { src is "/img/blog/moving-to-moose-hackathon/lodge-interior.jpg" };
};
...
figure {
img { src is "/img/blog/moving-to-moose-hackathon/picnic.jpg" };
};

figure {
img { src is "/img/blog/moving-to-moose-hackathon/rocky-forest.jpg" };
};

figure {
img { src is "/img/blog/moving-to-moose-hackathon/wave-of-trees.jpg" };
};

figure {
img { src is "/img/blog/moving-to-moose-hackathon/focused-cliff.jpg" };
};

figure {
img { src is "/img/blog/moving-to-moose-hackathon/pulpit-rock.jpg" };
};

figure {
img { src is "/img/blog/moving-to-moose-hackathon/topdown-cliff.jpg" };
};
...
figure {
img { src is "/img/blog/moving-to-moose-hackathon/stevan-peek.jpg" };
};

figure {
img { src is "/img/blog/moving-to-moose-hackathon/fluxx-rules.jpg" };
};

figure {
img { src is "/img/blog/moving-to-moose-hackathon/pro-perigrin.jpg" };
};
...
figure {
img { src is "/img/blog/moving-to-moose-hackathon/artsy-stevan.jpg" };
};

figure {
    img { src is "/img/blog/moving-to-moose-hackathon/perigrin-workstation.jpg" };
};
...
figure {
    img { src is "/img/blog/moving-to-moose-hackathon/doy-nothingmuch.jpg" };
};

figure {
    img { src is "/img/blog/moving-to-moose-hackathon/reminiscing.jpg" };
};
...
figure {
    img { src is "/img/blog/moving-to-moose-hackathon/roof-lawn.jpg" };
};
...
figure {
    img { src is "/img/blog/moving-to-moose-hackathon/tau-rainbow.jpg" };
};

figure {
    img { src is "/img/blog/moving-to-moose-hackathon/outbound-ferry.jpg" };
};

figure {
    img { src is "/img/blog/moving-to-moose-hackathon/comfort-food.jpg" };
};

figure {
    img { src is "/img/blog/moving-to-moose-hackathon/high-life.jpg" };
};
